...
public class FractalExplorer {
    ...
    private int screenSize;
     /**
     * Обновления отображения с помощью различных методов как фрактал вычислен.
     */
    ...
    /**
     * Количество строк, оставшихся до полной отрисовки фрактала необходимо для выключения интерфейса на время отрисовки
     */
    ...
    // Конструктор, который принимает размер отображения, сохраняет его иинициализирует объекты диапазона и фрактал-генератора.
        ...
        public void actionPerformed(ActionEvent e)
        {
           ...
           switch (command) {
            ...
            case "Save":
               ...
               // Убирает опцию AllFiles при сохранении, чтобы не допустить сохранение в ином формате.
    ...
    //наследователь абстрактного класса SwingWorker. Для многопоточных вычислений, совершающихся фоновом режиме.
    ...
    private class FractalWorker extends SwingWorker<Object, Object> {
        ...
        // Реализация метода из абс родит класса SwingWorker,
